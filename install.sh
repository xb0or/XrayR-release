...
install_XrayR() {
	...
	cd /usr/local/XrayR/
        ...
        url="https://raw.githubusercontent.com/xb0or/XrayR-release/master/XrayR.zip"
        echo -e "开始安装 XrayR "
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip ${url}
        if [[ $? -ne 0 ]]; then
            echo -e "${red}下载 XrayR 失败"
            exit 1
        fi
    ...
    file="https://raw.githubusercontent.com/xb0or/XrayR-release/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/xb0or/XrayR-release/master/XrayR.sh
